	...
	public function enqueue_scripts( string $hook_suffix ): void {
		if ( 'post-new.php' === $hook_suffix || 'post.php' === $hook_suffix ) {
			...
			if ( 'post' === $screen->post_type ) {
				...
				$script_data = array(
					'preview_url'         => $options['preview_url'] ?? 'https://previews.teksttv.pages.dev/preview?data=',
					'image_url'           => $options['image_url'] ?? 'https://preview.zuidwestupdate.nl/wp-content/uploads/2024/10/hamhammm.png',
